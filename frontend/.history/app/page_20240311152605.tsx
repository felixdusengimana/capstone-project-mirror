      ...
      <section className="mt-24 page-padding">
        ...
        <div className="grid grid-cols-2 gap-[18px] mt-12">
          ...
          <div>
            ...
            <Card title="Direct Engagement" icon="check">
              <span>Direct Interaction</span> Engage directly with your favorite
              influencers, fostering a closer connection and deeper relationship
            </Card>
          </div>
        </div>
