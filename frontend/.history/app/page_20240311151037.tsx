    ...
    <div className="py-[73px]">
      ...
      <section className="mt-24 page-padding">
        ...
        <div className="grid grid-cols-2 gap-[18px] mt-12">
          <div>
            <Avatar alt="Profile 1" src="/profiles/profile1.png" size="2xl" />
            <Avatar alt="Profile 2" src={"/profiles/profile4.png"} size="2xl" />
            <Avatar alt="Profile 3" src={"/profiles/profile3.png"} size="2xl" />
            <Avatar alt="Profile 4" src={"/profiles/profile4.png"} size="2xl" />
          </div>
          <div></div>
        </div>
      </section>
