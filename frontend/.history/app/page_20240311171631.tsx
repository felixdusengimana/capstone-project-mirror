    ...
    <div className="py-[73px]">
      ...
      <section className="mt-24 page-padding">
        <div className="grid grid-cols-4 grid-rows-3 min-h-[862px] gap-6">
          <div className="bg-[url('/creator-bg.png')] bg-cover bg-no-repeat row-span-2 bg-red-400 rounded-[32px] px-6 flex items-center justify-center">
          ...
          <div className="col-span-2">
            ...
            >
              <div className="max-w-[316px] flex justify-center mx-auto relative">
                ...
                />
                <Transaction
                  className="absolute top-0 max-w-[277px] z-30 bg-[#66666E]"
                  currency="RWF"
                  status="completed"
                  date={"Dec 9, 2022"}
                  user={{
                ...
                />
                <Transaction
                  className="absolute top-1 max-w-[251px] z-20 bg-[#404045]"
                  currency="RWF"
                  status="completed"
                  date={"Dec 9, 2022"}
                  user={{
                ...
                />
                <Transaction
                  className="absolute top-3 max-w-[205px] z-10 bg-[#3a3ac4]"
                  currency="RWF"
                  status="completed"
                  date={"Dec 9, 2022"}
                  user={{
